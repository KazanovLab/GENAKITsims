...
//    int rnd_cnt;
    ...
    MUTSIG(char *t, char *m, char r, char a) { strncpy(muttype, t, 7); strncpy(motif, m, 3); motif[3]='\0'; cREF=r; cALT=a; };
};

//------------------------------------------------------------------

#define MAX_MUTAGEN 64
...
struct MUTAGEN {
    ...
    vector < double > fract_rt_gene;     //  = 0:7  (RT0 ... RT7)
    vector < double > fract_rt_intg;     //  = 0:7  (RT0 ... RT7)
